...
public class TextSectionData extends SectionData {
    ...
    public CLRMetaData getMetaData() {
        return metaData;
    }
    ...
    protected void parseMetaData(InputStreamReader reader) throws IOException, LoadException {
        RVAAndSize entry = this.getRuntimeHeader().getMetaData();
        if (entry.getSize() > 0) {
            super.jumpToEntry(entry, reader, peHeader.getBaseOfCode());

            if(this.metaData==null) {
                this.metaData=new CLRMetaData();
            }
